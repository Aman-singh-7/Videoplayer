...
public class MainActivity extends AppCompatActivity implements videoRVAdapater.VideoClickInterface {

    private RecyclerView videoRV;
    private ArrayList<VideoRVModal> videoRVModalArrayList;
    private  videoRVAdapater videoRVadapter;
    private  static final int STORAGE_PERMISSION=101;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        videoRV=findViewById(R.id.id_RV_videos);
        videoRVModalArrayList=new ArrayList<>();
        videoRVadapter =new videoRVAdapater(videoRVModalArrayList,this,this::onVideoClick);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull  String[] permissions,  int[] grantResults) {
        ...
        if(requestCode==STORAGE_PERMISSION)
        {
            ...
            {
                Toast.makeText(this,"Needs permission to app work..",Toast.LENGTH_SHORT).show();
                finish();
            }
    ...
    private  void getVideos()
    {
        ...
        if(cursor!=null&&cursor.moveToFirst())
        {
            do{
                ...
                videoRVModalArrayList.add(new VideoRVModal(videoPath,videoPath,videoThumbnail));
    ...
    public void onVideoClick(int position) {
        ...
        Toast.makeText(this,videoRVModalArrayList.get(position).getVideoName(),Toast.LENGTH_SHORT).show();
